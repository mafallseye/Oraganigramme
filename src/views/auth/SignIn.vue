<template>
    <div
        class="main auth-layout-wrap flex justify-center min-h-screen flex-col bg-cover items-center"
    >
                ...
                <div class="p-10">
                    <div class="">
                        <div class="p-5">
                            ...
                            <h1
                                class="mb-3 text-lg text-center pb-2 text-blue-indigo-500 text-2xl"
                            >
                                Sign In
                            </h1>
                            <div
                            ...
                            <form>
                                <div class="mb-3 mt-2">
                                    <label class="text-md text-gray-600" for=""
                                        >Identifiant</label
                                    >
                                    ...
                                    <input
                                        ...
                                        type="text"
                                        v-model="identifiant"
                                        placeholder="Type your identifiant here"
                                        class="input border-solid border-2 border-red-300 w-full max-w-xs"
                                    />
                                    <input
                                        v-else
                                        type="text"
                                        v-model="identifiant"
                                        placeholder="Type your identifiant here"
                                        class="input border-solid border-2 border-blue-indigo-500 w-full max-w-xs"
                                    />
                                </div>
                                ...
                                <div class="mb-4">
                                    <button
                                        type="button"
                                        @click="Login()"
                                        class="btn btn-block bg-blue-indigo-700 hover:bg-blue-indigo-500"
                                    >
                                        Sign In
                                    </button>
                                </div>
